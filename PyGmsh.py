...
#
    def add_point(self,x,y,z,size):
        ...
        global  _id_Points
        _id_Points =  _id_Points + 1

        point = gp(_id_Points,x,y,z,size)
...
#
    def add_line(self,p_ids,linetype='line'):
        ...
        line = gl(_id_Lines,p_ids,linetype)
...
#
    def add_lineloop(self,line_ids):
        ...
        _id_LineLoops = _id_LineLoops + 1
        lineloop = gll(_id_LineLoops,line_ids)
        self.LineLoops.append(lineloop)

        _id_PlaneSurfaces = _id_PlaneSurfaces + 1
        if _id_PlaneSurfaces < 2:
            planesurface = gps(_id_PlaneSurfaces,lineloop.lineloop_id)
...
#
    def add_physical(self,name,ids,phystype):
        ...
        phys = gphys(_id_Physicals,name,ids,phystype)
